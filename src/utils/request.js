...
service.interceptors.response.use(res => {
    ...
    } else if ([1002, 10030, 10031, 10032, 10033].includes(+code)) {
      return res.data
    } else if (code !== 200) {
      Notification.error({
        title: msg
...
export function download(url, params, filename) {
  downloadLoadingInstance = Loading.service({ text: "downloading... Please waiting", spinner: "el-icon-loading", background: "rgba(0, 0, 0, 0.7)", })
